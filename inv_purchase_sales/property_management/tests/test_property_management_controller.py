...
from odoo.addons.property_management.controllers import (
    property_management as controller_module,
)
...
class TestPropertyController(TransactionCase):
    ...
    def test_property_route_renders_property_list(self):
        ...
        self.assertEqual(
            result["template"],
            "property_management.property_view",
        )
    ...
    def test_property_item_route_renders_single_property(self):
        ...
        self.assertEqual(
            result["template"],
            "property_management.property_view_item",
        )
    ...
    def test_auction_route_groups_auctions(self):
        ...
        self.assertEqual(
            result["template"],
            "property_management.auction_view",
        )
